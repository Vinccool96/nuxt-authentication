...
import type { Token, IdToken, RefreshToken, RefreshController, RequestHandler } from "../inc"
...
export interface TokenableScheme<OptionsT extends TokenableSchemeOptions = TokenableSchemeOptions>
...
export interface IdTokenableScheme<OptionsT extends IdTokenableSchemeOptions = IdTokenableSchemeOptions>
  extends Scheme<OptionsT> {
  idToken: IdToken
  requestHandler: RequestHandler
}
...
export interface RefreshableScheme<OptionsT extends RefreshableSchemeOptions = RefreshableSchemeOptions>
